namespace Edumination.WinForms.UI.Forms.TestTaking.SpeakingTest
{
    partial class SpeakingTest
    {
        ...
        {
            testNavBar = new Edumination.WinForms.UI.Forms.TestTaking.Controls.TestNavBarPanel();
            testFooter = new Edumination.WinForms.UI.Forms.TestTaking.Controls.TestFooterPanel();
            lblPart = new Sunny.UI.UILabel();
            lblTitle = new Sunny.UI.UILabel();
            lblQuestion = new Sunny.UI.UILabel();
            audioPanel = new Edumination.WinForms.UI.Forms.TestTaking.Controls.AudioRecorderPanel();
            SuspendLayout();
            // 
            // testNavBar
            // 
